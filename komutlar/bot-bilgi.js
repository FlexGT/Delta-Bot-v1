...
module.exports.run = async (bot, message) => {
  try {
    ...
    const embed = new Discord.RichEmbed()
      ...
      .addField(`Destek Sunucusu`, `[Tıkla!](https://discord.gg/NF6avRa6`, true)
      .addField(
        `Botu Ekleyin`,
        `[Tıkla!](https://discord.com/oauth2/authorize?client_id=824279183269298187&scope=bot&permissions=8)`,
        true
      )
